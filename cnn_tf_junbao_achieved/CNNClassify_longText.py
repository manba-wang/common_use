...
class CNNClassify:
    ...
    def cNNClassify(self, input):
        ...
        res_dict = {}
        res_dict['result'] = s
        res_dict['result_all'] = s_all
        res_dict['pool_3'] = pool_3
        res_dict['pool_4'] = pool_4
        res_dict['pool_5'] = pool_5
        res_json = json.dumps(res_dict,sort_keys=True,ensure_ascii=False)
        '''
        return s
    ...
    def cNNClassify_seg(self, input_seg):
        ...
        scores = predict_longText.predict(sentence, 2000, self.vocabulary_invmap, self.cnn_model, self.labels)
